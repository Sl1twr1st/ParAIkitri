    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50/50 flex items-center justify-center">
      ...
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10 text-center">
        ...
        <header className="space-y-6">
          <h1 className="text-5xl font-bold tracking-tight sm:text-7xl bg-gradient-to-r from-red-900 via-gray-800 to-gray-900 bg-clip-text text-transparent">
            JANGAN<br />"ONANI"<br />MENDING<br />"MASTURBASI"
          </h1>
          <p className="max-w-[600px] text-lg text-gray-600 md:text-xl/relaxed xl:text-2xl/relaxed">
            <i>yang artinya:</i><br />Jangan Jadi "Online Netizen Aktif Namun Impulsif"<br />mending jadi "Masyarakat yang Teratur Baik dan Serasi"
            <br />
            <span className="text-gray-400 text-sm">
              Penerbit KPG Proudly Present:<br /><b>Sebuah Tribute untuk Parakitri T. Simbolon</b>
            </span>
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-8 max-w-3xl mx-auto">
          {[
            ...
            { title: "Smart", description: "Powered by Anthropic Claude 3.5 Sonnet" },
