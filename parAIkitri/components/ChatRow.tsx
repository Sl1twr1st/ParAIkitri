...
function ChatRow({
    ...
    return (
        <div
            className="group rounded-xl border border-gray-200/30 bg-white-50 background-blur-sm
            ...
            <div className="p-4">
                ...
                {lastMessage && lastMessage.createdAt ? (
                    <p className="text-xs text-gray-400 mt-1.5 font-medium">
                        <TimeAgo date={new Date(lastMessage.createdAt)} />
                    </p>
                ) : (
                    <p className="text-xs text-gray-400 mt-1.5 italic">No messages yet</p>
                )}
            </div>
        </div>
    );
